    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoRow(Icons.person_outline, 'Họ và tên', provider.state.receiverName),
          const SizedBox(height: 12),
          _buildInfoRow(Icons.phone_iphone_outlined, 'Số điện thoại', provider.state.receiverPhone),
          const SizedBox(height: 12),
