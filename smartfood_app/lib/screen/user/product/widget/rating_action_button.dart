...
import 'package:smartfood_app/screen/user/product/widget/rating_dialog.dart';
...
class RatingActionButton extends StatelessWidget {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return RatingDialog(
          ...
          onRatingSubmitted: () {
            provider.loadProductDetail(provider.product!.id);
  ...
  Future<void> _deleteRating(BuildContext context) async {
    ...
    if (confirmed == true) {
      try {
        final success =
        await provider.deleteRating(provider.product!.id);
